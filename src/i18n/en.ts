export const en = {
  ...
  settings: {
    ...
    customCorsProxy: 'Custom CORS Proxy (Optional)',
    customCorsProxyPlaceholder: 'e.g., https://your-worker.workers.dev',
    customCorsProxyHint: 'Deploy your own CORS proxy to Cloudflare Workers for better reliability. Leave empty to use public proxies.',
  ...
  travel: {
    ...
    subtitle: 'Plan your trips and track expenses',
    // Plan
    newPlan: '+ New Trip',
    editPlan: 'Edit Trip',
    planName: 'Trip Name',
    planNamePlaceholder: 'e.g., 2026 Japan Trip',
    destination: 'Destination',
    destinationPlaceholder: 'e.g., Tokyo, Japan',
    startDate: 'Start Date',
    endDate: 'End Date',
    defaultCurrency: 'Default Currency',
    selectPlan: 'Select a trip to view',
    noPlans: 'No trips yet. Create your first trip to get started!',
    deletePlanConfirm: 'Are you sure you want to delete this trip? All data will be lost.',
    // Flights
    flights: 'Flights',
    ...
    flightNumberPlaceholder: 'e.g., BR108',
    airline: 'Airline',
    ...
    hotelNamePlaceholder: 'e.g., Tokyo Hilton',
    checkIn: 'Check-in',
    checkOut: 'Check-out',
    address: 'Address',
    ...
    nights: 'nights',
    // Attractions
    unconfirmedAttractions: 'Unconfirmed Attractions',
    ...
    viewDetails: 'View Details',
    // Itinerary Detail
    itineraryDetail: 'Itinerary Detail',
    addItem: '+ Add Item',
    editItem: 'Edit Item',
    itemName: 'Name',
    itemType: 'Type',
    startTime: 'Start Time',
    stayDuration: 'Stay Duration (min)',
    travelTime: 'Travel to Next (min)',
